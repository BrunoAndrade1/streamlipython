...
''' nessa parte mexe nas cores do grafico ["#ffffff", "#f25829", "#f2a529", "#eff229", "#85e043", "#2bad4e"], "quadrant_text": ["", "<b style='font-size:10px;'>V high</b>", "<b style='font-size:10px;'>High</b>", "<b style='font-size:10px;'>M</b>", "<b style='font-size:10px;'>L</b>", "<b style='font-size:10px;'>Very l</b>"], "sensor_text": "Lucro Líquido"},
Exemplo se alterar #ffffff para azul claro tenho que colocar #def,ou seja mecher nas  configuração codigo hexadecimal  '''
