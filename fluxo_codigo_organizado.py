...
st.markdown("<h6 style='text-align: center; color: black;'>Previsão de Faturamento</h3>", unsafe_allow_html=True)

# Set option to ignore warnings
...
# Documentaçaõ https://plotly.com/python/creating-and-updating-figures/#updating-figure-layouts
